...
cd ./output
find . -name '16000' -type d | xargs tar cfpzv ../freeswitch-sounds-de-de-callie-16000-0.0.4.tar.gz
find . -name '8000' -type d | xargs tar cfpzv ../freeswitch-sounds-de-de-callie-8000-0.0.4.tar.gz
cd -
